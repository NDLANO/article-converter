...
export const articleWithMultipleResources = `
  ...
  <section>
     ...
     <p style="padding-left: 60px;"><strong>til kven </strong>– den tyske befolkninga</p>
     <p style="padding-left: 60px;"><strong>i kva kanal </strong>– film, radio, talar på store arenaer</p>
     <p style="padding-left: 60px;"><strong>med kva verknad </strong>– støtte i befolkninga</p>
     <p style="padding-left: 60px;"> </p>
     <p>*Propaganda tyder medviten manipulering av folks kjensler og tankar ved hjelp av sterke verkemiddel for å fremje bestemte oppfatningar og handlingar.</p>
  </section>
  <section>
     <h2>Underhaldning</h2>
     <p></p>
     ...
     <p style="padding-left: 60px;"><strong>seier kva</strong> – det er ikkje alltid like lett å ta skiheis</p>
     <p style="padding-left: 60px;"><strong>til kven</strong> – tilfeldige eller skiinteresserte folk på Facebook</p>
     <p style="padding-left: 60px;"><strong>i kva kanal</strong> – Facebook</p>
     <p style="padding-left: 60px;"><strong>med kva verknad </strong>– at folk ler</p>
  </section>
  <section>
     <h2>Journalistikk</h2>
     <p></p>
     ...
     <p> </p>
     <p style="padding-left: 60px;"><strong>Kven –</strong> VG</p>
     <p style="padding-left: 60px;"><strong>seier hva</strong> – fleire er skotne på Utøya</p>
     <p style="padding-left: 60px;"><strong>til kven</strong> – lesarane av VG</p>
     <p style="padding-left: 60px;"><strong>i kva kanal</strong> – Internett  / VG nettavis</p>
     <p style="padding-left: 60px;"><strong>med kva verknad</strong> – kjennskap til noko som har skjedd i samfunnet</p>
  </section>
  <section>
     <h2>Reklame</h2>
     <p></p>
     ...
     <p style="padding-left: 60px;"><strong>til kven</strong> – dei som kjøper saft og syltetøy</p>
     <p style="padding-left: 60px;"><strong>i kva kanal</strong> – YouTube, reklamekanalar på TV, kinoreklame</p>
     <p style="padding-left: 60px;"><strong>med kva verknad</strong> – at folk kjøper Lerums saft og syltetøy</p>
  </section>
  <section>
     <h2>Informasjon</h2>
     <p></p>
     ...
     <p style="padding-left: 60px;"><strong>til kven</strong> – ungdom (gutar særskilt)</p>
     <p style="padding-left: 60px;"><strong>i kva kanal</strong> – YouTube</p>
     <p style="padding-left: 60px;"><strong>med kva verknad</strong> – riktige haldninger til bilkøyring og fart</p>
     <p> </p>
  </section>
  <section>
     <p> </p>

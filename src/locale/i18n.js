...
const messages = {
  nb: {
    ...
    'audio.download': 'Last ned lydfil',
    'audio.rulesForUse': 'Regler for bruk av lydfil',
    'audio.reuse': 'Bruk lydfil',
    ...
    'audio.error.caption': 'Beklager, en feil oppsto ved lasting av lydfil.',
